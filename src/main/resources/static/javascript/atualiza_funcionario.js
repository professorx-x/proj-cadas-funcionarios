	    ...
	    (
	        ...
	        function(resposta)
	        {
	            ...
	            if(resposta != "")
	            {
		            ...
		            $('#nome2').attr('disabled', false);
		            $('#cargo2').attr('disabled', false);
		            $('#dataNascimento').attr('disabled', false);
		            //$('#dataCadastro').attr('disabled', false);
		            $('#submit').attr('disabled', false);
		            //alert(document.getElementById('nome1').value);
		        }
		    	else
		    	{
